...
##con toupper() llevamos a mayusculas todos los caracteres que nos interesan
...
##con chartr() reemplazamos los caracteres con tildes y la Ñ
...
AL COMIENZO UTILIZAMOS ESTE CODIGO PARA HOMOGENIZAR NOMBRES, Y FUNCIONÓ, PERO LUEGO TUVIMOS PROBLEMAS CON LA LIBRERIA FUZZYWUZZYR, Y SE OPTO POR UTILIZAR PYHTON.
```{r}
...
##Se utilizan solo 15 regiones, ya que se comprobo que el proyecto que mas regiones de impacto tiene son 15
```
...
##2: podemos ver la cantidad y proporcion de proyectos que tiene cada region
...
##5: podemos ver la cantidad de poblacion potencial por cada ambito de accion.
